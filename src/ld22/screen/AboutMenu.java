...
public class AboutMenu extends Menu {
	...
	public void render(Screen screen) {
		...
		Font.draw(
				"Moded by David.b and +Dillyg10+", screen, 2 * 8 + 4, 3 * 8, Color.get(0, 333, 333, 333));
		Font.draw(
				"Our goal is to expand Minicraft to",
				screen,
				1 * 8 + 4,
				5 * 8,
		...
		Font.draw(
				"Minicraft made by Markus Perrson", screen, 1 * 8 + 4, 8 * 8, Color.get(0, 333, 333, 333));
		Font.draw(
				"for ludum dare 22 competition.", screen, 2 * 8 + 4, 9 * 8, Color.get(0, 333, 333, 333));
	}
}
