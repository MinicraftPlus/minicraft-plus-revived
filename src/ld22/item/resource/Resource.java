...
public class Resource {
	...
	public static Resource leather =
			new Resource("Leather", 19 + 4 * 32, Color.get(-1, 100, 211, 322));
	...
	public static Resource sand =
			new PlantableResource(
					"Sand", 2 + 4 * 32, Color.get(-1, 110, 440, 550), Tile.sand, Tile.dirt, Tile.lightdirt);
	...
	public static Resource seeds =
			new PlantableResource(
					"Seeds", 5 + 4 * 32, Color.get(-1, 10, 40, 50), Tile.wheat, Tile.farmland);
	...
	public static Resource bone =
			new PlantableResource(
					"Bone",
					15 + 4 * 32,
					Color.get(-1, 222, 555, 555),
					Tile.tree,
					Tile.treeSapling,
					Tile.lightts);
	public static Resource wheat = new Resource("Wheat", 6 + 4 * 32, Color.get(-1, 110, 330, 550));
	public static Resource bread =
			new FoodResource("Bread", 8 + 4 * 32, Color.get(-1, 110, 330, 550), 2, 5);
	public static Resource apple =
			new FoodResource("Apple", 9 + 4 * 32, Color.get(-1, 100, 300, 500), 1, 5);
	public static Resource rawpork =
			new FoodResource("Raw Pork", 20 + 4 * 32, Color.get(-1, 211, 311, 411), 1, 5);
	public static Resource rawfish =
			new FoodResource("Raw Fish", 24 + 4 * 32, Color.get(-1, 660, 670, 680), 1, 5);
	public static Resource rawbeef =
			new FoodResource("Raw Beef", 20 + 4 * 32, Color.get(-1, 200, 300, 400), 1, 5);
	public static Resource bacon =
			new FoodResource("Pork Chop", 20 + 4 * 32, Color.get(-1, 220, 440, 330), 3, 5);
	public static Resource cookedfish =
			new FoodResource("Cooked Fish", 24 + 4 * 32, Color.get(-1, 220, 330, 440), 3, 5);
	public static Resource cookedpork =
			new FoodResource("Cooked Pork", 148, Color.get(-1, 220, 440, 330), 3, 5);
	public static Resource steak =
			new FoodResource("Steak", 20 + 4 * 32, Color.get(-1, 100, 333, 211), 3, 5);
	public static Resource goldapple =
			new FoodResource("G.Apple", 9 + 4 * 32, Color.get(-1, 110, 440, 550), 10, 5);
	public static Resource larmor =
			new ArmorResource("L.Armor", 3 + 12 * 32, Color.get(-1, 100, 211, 322), 3, 9);
	public static Resource sarmor =
			new ArmorResource("S.Armor", 3 + 12 * 32, Color.get(-1, 10, 20, 30), 4, 9);
	public static Resource iarmor =
			new ArmorResource("I.Armor", 3 + 12 * 32, Color.get(-1, 100, 322, 544), 5, 9);
	public static Resource garmor =
			new ArmorResource("G.Armor", 3 + 12 * 32, Color.get(-1, 110, 330, 553), 7, 9);
	public static Resource gemarmor =
			new ArmorResource("Gem Armor", 3 + 12 * 32, Color.get(-1, 101, 404, 545), 10, 9);
	...
	public static Resource ironOre =
			new Resource("Iron Ore", 10 + 4 * 32, Color.get(-1, 100, 322, 544));
	public static Resource lapisOre =
			new Resource("Lapis", 10 + 4 * 32, Color.get(-1, 005, 115, 115));
	public static Resource goldOre =
			new Resource("Gold Ore", 10 + 4 * 32, Color.get(-1, 110, 440, 553));
	public static Resource ironIngot =
			new Resource("Iron", 11 + 4 * 32, Color.get(-1, 100, 322, 544));
	public static Resource goldIngot =
			new Resource("Gold", 11 + 4 * 32, Color.get(-1, 110, 330, 553));

	public static Resource rod =
			new ItemResource("Fish Rod", 6 + 5 * 32, Color.get(-1, 320, 320, 444));
	...
	public static Resource bookant =
			new ItemResource("Antidious", 14 + 4 * 32, Color.get(-1, 100, 300, 500));
	public static Resource cloud =
			new PlantableResource(
					"cloud", 2 + 4 * 32, Color.get(-1, 222, 555, 444), Tile.cloud, Tile.infiniteFall);
