...
public class TorchItem extends TileItem {
	...
	private TorchItem(int count) {
		super("Torch", new LinkedSprite(SpriteType.Item, "torch"), count, new TileModel(""), "dirt", "Wood Planks", "Stone Bricks", "Obsidian", "White Wool", "Red Wool", "Blue Wool", "Green Wool", "Yellow Wool", "Black Wool", "grass", "sand","path","ornate stone","ornate obsidian");
	}
