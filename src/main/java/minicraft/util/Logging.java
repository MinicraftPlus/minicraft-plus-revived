...
public final class Logging {
	...
	public static final TaggedLogger RESOURCEHANDLER_LOCALIZATION = Logger.tags("Resource Handler", "Localization");
	public static final TaggedLogger RESOURCEHANDLER_SOUND = Logger.tags("Resource Handler", "Sound");
	public static final TaggedLogger RESOURCEHANDLER_SKIN = Logger.tags("Resource Handler", "Skin");
	public static final TaggedLogger RESOURCEHANDLER_RESOURCEPACK = Logger.tags("Resource Handler", "Resource Pack");
