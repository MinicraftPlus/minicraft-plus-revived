...
public class Settings {
	...
	static {
		...
		options.put("screenshot", new ArrayEntry<>("minicraft.settings.screenshot_scale", 1, 2, 5, 10, 15, 20, 25, 30, 35, 40, 50, 60, 80, 100, 120, 150)); // The magnification of screenshot. I would want to see ultimate sized.
