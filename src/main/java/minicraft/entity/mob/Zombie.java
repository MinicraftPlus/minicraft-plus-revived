...
public class Zombie extends EnemyMob {
	private static LinkedSpriteSheet[] sprites = new LinkedSpriteSheet[] {
		new LinkedSpriteSheet(SpriteType.Entity, "zombie"),
		new LinkedSpriteSheet(SpriteType.Entity, "zombie").setSpritePos(0, 2),
		new LinkedSpriteSheet(SpriteType.Entity, "zombie").setSpritePos(0, 4),
		new LinkedSpriteSheet(SpriteType.Entity, "zombie").setSpritePos(0, 6)
	};
