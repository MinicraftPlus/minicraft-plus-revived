...
public class AirWizard extends EnemyMob {
	...
	public void die() {
		...
		if(!secondform) {
			...
			// Achievement:
			if (!Game.isMode("creative")) AchievementsDisplay.setAchievement("minicraft.achievement.airwizard", true);
			if (!beaten) {
			...
			// Second Achievement:
			if (!Game.isMode("creative")) AchievementsDisplay.setAchievement("minicraft.achievement.second_airwizard", true);
