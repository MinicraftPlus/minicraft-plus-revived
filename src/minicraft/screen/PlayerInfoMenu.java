...
public class PlayerInfoMenu extends Menu {
	...
	public void render(Screen screen) {
		...
		if (ModeMenu.creative)
			Font.draw("inf", screen, (2 + 7) * 8, 7 * 8, Color.get(-1, 550, 550, 550));
		else
			Font.draw("" + game.player.health, screen, (2 + 7) * 8, 7 * 8, Color.get(-1, 550, 550, 550));
		Font.draw("Hunger:", screen, 2 * 8, 8 * 8, Color.get(-1, 555, 555, 555));
		if (ModeMenu.creative)
			Font.draw("inf", screen, (2 + 7) * 8, 8 * 8, Color.get(-1, 550, 550, 550));
		else
		...
		if (OptionsMenu.diff == OptionsMenu.easy || ModeMenu.creative) {
			...
			Font.draw("" + cStep, screen, (2 + 18) * 8, 10 * 8, Color.get(-1, 550, 550, 550));
		}
