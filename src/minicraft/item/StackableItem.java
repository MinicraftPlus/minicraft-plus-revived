...
public class StackableItem extends Item {
	...
	protected static ArrayList<Item> getAllInstances() {
		...
		items.add(new StackableItem("Iron Ore", new Sprite(10, 4, 0)));
		items.add(new StackableItem("Lapis", new Sprite(10, 4, 0)));
		items.add(new StackableItem("Gold Ore", new Sprite(10, 4, 0)));
		items.add(new StackableItem("Iron", new Sprite(11, 4, 0)));
		items.add(new StackableItem("Gold", new Sprite(11, 4, 0)));
		items.add(new StackableItem("Rose", new Sprite(5, 0, 0)));
		items.add(new StackableItem("GunPowder", new Sprite(22, 4, 0)));
		items.add(new StackableItem("Slime", new Sprite(10, 4, 0)));
		items.add(new StackableItem("glass", new Sprite(12, 4, 0)));
		items.add(new StackableItem("cloth", new Sprite(9, 0, 0)));
		items.add(new StackableItem("gem", new Sprite(13, 4, 0)));
		items.add(new StackableItem("Scale", new Sprite(22, 4, 0)));
		items.add(new StackableItem("Shard", new Sprite(23, 4, 0)));
