...
public class Recipes {
	...
	static {
		...
		workbenchRecipes.add(new Recipe("Wood Fishing Rod_1", "Wood_15", "String_3"));
		workbenchRecipes.add(new Recipe("Iron Fishing Rod_1", "Iron_15", "String_3"));
		workbenchRecipes.add(new Recipe("Gold Fishing Rod_1", "Gold_15", "String_3"));
		workbenchRecipes.add(new Recipe("Gem Fishing Rod_1", "Gem_15", "String_3"));
