...
public class BookItem extends Item {
	...
	private BookItem(String title, int color, String text, boolean hasTitlePage) {
	...
	public boolean interactOn(Tile tile, Level level, int xt, int yt, Player player, Direction attackDir) {
		Game.setMenu(new BookDisplay(text, hasTitlePage));
		return true;
	}
	...
	public BookItem clone() {
		return new BookItem(getName(), sprite.color, text, hasTitlePage);
	}
