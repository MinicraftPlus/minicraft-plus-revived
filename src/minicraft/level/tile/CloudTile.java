...
public class CloudTile extends Tile {
	private static ConnectorSprite sprite = new ConnectorSprite(CloudTile.class, new Sprite(4, 0, 3, 3, Color.get(333, 444, 555, -1), 3), new Sprite(7, 0, 2, 2, Color.get(333, 444, 555, -1), 3), ConnectorSprite.makeSprite(2, 2, 0, false, 19, 18, 20, 19))
	{
