...
public interface MinicraftConnection {
	...
	enum InputType {
		INVALID, USERNAMES, LOGIN, GAME, INIT, TILES, ENTITIES, TILE, ENTITY, PLAYER, MOVE, ADD, REMOVE, DISCONNECT, SAVE, NOTIFY, INTERACT, PUSH, PICKUP, CHESTIN, CHESTOUT, BED, POTION, HURT, DIE, RESPAWN;
