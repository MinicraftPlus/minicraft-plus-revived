		...
		for (int y = y0; y <= y1; y++) {
			for (int x = x0; x <= x1; x++) {
				if (x == x0 && y == y0)
					...
					screen.render(x * 8, y * 8, 1 + 13 * 32, Color.get(-1, 1, 300, 400), 0);
				else if (y == y1)
					screen.render(x * 8, y * 8, 1 + 13 * 32, Color.get(-1, 1, 300, 400), 2);
				else if (x == x0)
					screen.render(x * 8, y * 8, 2 + 13 * 32, Color.get(-1, 1, 300, 400), 0);
				else if (x == x1)
					screen.render(x * 8, y * 8, 2 + 13 * 32, Color.get(-1, 1, 300, 400), 1);
				else
			...
			for (int y = y0; y <= y1; y++) {
				for (int x = x0; x <= x1; x++) {
					if (x == x0 && y == y0)
						...
						screen.render(x * 8, y * 8, 1 + 13 * 32, Color.get(-1, 1, 554, 554), 0);
					else if (y == y1)
						screen.render(x * 8, y * 8, 1 + 13 * 32, Color.get(-1, 1, 554, 554), 2);
					else if (x == x0)
						screen.render(x * 8, y * 8, 2 + 13 * 32, Color.get(-1, 1, 554, 554), 0);
					else if (x == x1)
						screen.render(x * 8, y * 8, 2 + 13 * 32, Color.get(-1, 1, 554, 554), 1);
					else
