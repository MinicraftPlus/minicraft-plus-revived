...
public class Skeleton extends Mob {
	...
	protected void die() {
		...
		for (int i = 0; i < count; i++) {
			level.add(new ItemEntity(new ResourceItem(Resource.bone), x + random.nextInt(11) - 5, y + random.nextInt(11) - 5));
			level.add(new ItemEntity(new ResourceItem(Resource.arrow), x + random.nextInt(11) - 5, y + random.nextInt(11) - 5));
		}
		else if (rand >= 14 && rand != 19)
			for (int i = 0; i < bookcount; i++) {
				level.add(new ItemEntity(new ResourceItem(Resource.arrow), x + random.nextInt(11) - 5, y + random.nextInt(11) - 5));
				level.add(new ItemEntity(new ResourceItem(Resource.bookant), x + random.nextInt(11) - 5, y + random.nextInt(11) - 5));
			}
