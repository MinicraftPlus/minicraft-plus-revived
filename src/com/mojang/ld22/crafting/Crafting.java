	...
	static {
		try {
			if (ModeMenu.creative) {
				...
				craftRecipes.add(
						new ResourceRecipe(Resource.torch).addCost(Resource.wood, 0).addCost(Resource.coal, 0));
				...
				craftRecipes.add(
						new ToolRecipe(ToolType.hatchet, 0)
								.addCost(Resource.wood, 0)
								.addCost(Resource.stone, 0));
				craftRecipes.add(
						new ToolRecipe(ToolType.spade, 0).addCost(Resource.wood, 0).addCost(Resource.stone, 0));
				craftRecipes.add(
						new ToolRecipe(ToolType.pick, 0).addCost(Resource.wood, 0).addCost(Resource.stone, 0));
				...
				workbenchRecipes.add(
						new FurnitureRecipe(Lantern.class)
								.addCost(Resource.wood, 0)
								.addCost(Resource.slime, 0)
								.addCost(Resource.glass, 0));
				...
				workbenchRecipes.add(
						new FurnitureRecipe(Bed.class).addCost(Resource.wool, 0).addCost(Resource.wood, 0));

				workbenchRecipes.add(
						new ResourceRecipe(Resource.rod).addCost(Resource.wood, 0).addCost(Resource.string, 0));
				...
				workbenchRecipes.add(
						new ToolRecipe(ToolType.sword, 1).addCost(Resource.wood, 0).addCost(Resource.stone, 0));
				workbenchRecipes.add(
						new ToolRecipe(ToolType.axe, 1).addCost(Resource.wood, 0).addCost(Resource.stone, 0));
				workbenchRecipes.add(
						new ToolRecipe(ToolType.hoe, 1).addCost(Resource.wood, 0).addCost(Resource.stone, 0));
				workbenchRecipes.add(
				...
				workbenchRecipes.add(
						new ToolRecipe(ToolType.shovel, 1)
								...
								.addCost(Resource.stone, 0));
				workbenchRecipes.add(
						new FurnitureRecipe(Tnt.class).addCost(Resource.gunp, 0).addCost(Resource.sand, 0));

				loomRecipes.add(new ResourceRecipe(Resource.string).addCost(Resource.wool, 0));
				loomRecipes.add(
						new ResourceRecipe(Resource.redwool)
								.addCost(Resource.wool, 0)
								.addCost(Resource.rose, 0));
				loomRecipes.add(
						new ResourceRecipe(Resource.bluewool)
								.addCost(Resource.wool, 0)
								.addCost(Resource.lapisOre, 0));
				loomRecipes.add(
						new ResourceRecipe(Resource.greenwool)
								.addCost(Resource.wool, 0)
								.addCost(Resource.cactusFlower, 0));
				loomRecipes.add(
						new ResourceRecipe(Resource.yellowwool)
								.addCost(Resource.wool, 0)
								.addCost(Resource.flower, 0));
				loomRecipes.add(
						new ResourceRecipe(Resource.blackwool)
								.addCost(Resource.wool, 0)
								.addCost(Resource.coal, 0));
				loomRecipes.add(
						new FurnitureRecipe(Bed.class).addCost(Resource.wood, 0).addCost(Resource.wool, 0));

				anvilRecipes.add(
						new ToolRecipe(ToolType.sword, 2)
								.addCost(Resource.wood, 0)
								.addCost(Resource.ironIngot, 0));
				anvilRecipes.add(
				...
				anvilRecipes.add(
						new ToolRecipe(ToolType.sword, 4).addCost(Resource.wood, 0).addCost(Resource.gem, 0));
				anvilRecipes.add(
						new ToolRecipe(ToolType.axe, 4).addCost(Resource.wood, 0).addCost(Resource.gem, 0));
				anvilRecipes.add(
						new ToolRecipe(ToolType.hoe, 4).addCost(Resource.wood, 0).addCost(Resource.gem, 0));
				anvilRecipes.add(
						new ToolRecipe(ToolType.pickaxe, 4).addCost(Resource.wood, 0).addCost(Resource.gem, 0));
				anvilRecipes.add(
						new ToolRecipe(ToolType.shovel, 4).addCost(Resource.wood, 0).addCost(Resource.gem, 0));

				furnaceRecipes.add(
						new ResourceRecipe(Resource.ironIngot)
								.addCost(Resource.ironOre, 0)
								.addCost(Resource.coal, 0));
				furnaceRecipes.add(
						new ResourceRecipe(Resource.goldIngot)
								.addCost(Resource.goldOre, 0)
								.addCost(Resource.coal, 0));
				furnaceRecipes.add(
						new ResourceRecipe(Resource.glass).addCost(Resource.sand, 0).addCost(Resource.coal, 0));

				ovenRecipes.add(
						new ResourceRecipe(Resource.bacon)
								.addCost(Resource.rawpork, 1)
								.addCost(Resource.coal, 1));
				ovenRecipes.add(
						new ResourceRecipe(Resource.steak)
								.addCost(Resource.rawbeef, 1)
								.addCost(Resource.coal, 1));

				enchantRecipes.add(
						new ResourceRecipe(Resource.goldapple)
								.addCost(Resource.apple, 0)
								.addCost(Resource.goldIngot, 0));
				enchantRecipes.add(
						new ResourceRecipe(Resource.grassseeds)
								.addCost(Resource.seeds, 0)
								.addCost(Resource.flower, 0));
				...
				craftRecipes.add(
						new ResourceRecipe(Resource.torch).addCost(Resource.wood, 1).addCost(Resource.coal, 1));
				...
				craftRecipes.add(
						new ToolRecipe(ToolType.hatchet, 1)
								.addCost(Resource.wood, 3)
								.addCost(Resource.stone, 3));
				craftRecipes.add(
						new ToolRecipe(ToolType.spade, 1).addCost(Resource.wood, 3).addCost(Resource.stone, 3));
				craftRecipes.add(
						new ToolRecipe(ToolType.pick, 1).addCost(Resource.wood, 3).addCost(Resource.stone, 3));
				...
				workbenchRecipes.add(
						new FurnitureRecipe(Lantern.class)
								.addCost(Resource.wood, 10)
								.addCost(Resource.slime, 5)
				...
				workbenchRecipes.add(
						new FurnitureRecipe(Tnt.class).addCost(Resource.gunp, 10).addCost(Resource.sand, 8));
				workbenchRecipes.add(
						new FurnitureRecipe(Loom.class).addCost(Resource.wood, 10).addCost(Resource.wool, 5));

				workbenchRecipes.add(
						new ResourceRecipe(Resource.rod).addCost(Resource.wood, 5).addCost(Resource.string, 5));

				loomRecipes.add(new ResourceRecipe(Resource.string).addCost(Resource.wool, 1));

				loomRecipes.add(
						new ResourceRecipe(Resource.redwool)
								.addCost(Resource.wool, 1)
								.addCost(Resource.rose, 1));
				loomRecipes.add(
						new ResourceRecipe(Resource.bluewool)
								.addCost(Resource.wool, 1)
								.addCost(Resource.lapisOre, 1));
				loomRecipes.add(
						new ResourceRecipe(Resource.greenwool)
								.addCost(Resource.wool, 1)
								.addCost(Resource.cactusFlower, 1));
				loomRecipes.add(
						new ResourceRecipe(Resource.yellowwool)
								.addCost(Resource.wool, 1)
								.addCost(Resource.flower, 1));
				loomRecipes.add(
						new ResourceRecipe(Resource.blackwool)
								.addCost(Resource.wool, 1)
								.addCost(Resource.coal, 1));
				loomRecipes.add(
						new FurnitureRecipe(Bed.class).addCost(Resource.wood, 5).addCost(Resource.wool, 3));
				...
				workbenchRecipes.add(
						new ToolRecipe(ToolType.bow, 0).addCost(Resource.wood, 5).addCost(Resource.string, 2));
				workbenchRecipes.add(
				...
				workbenchRecipes.add(
						new ToolRecipe(ToolType.shovel, 1)
								...
								.addCost(Resource.stone, 5));
				workbenchRecipes.add(
						new ToolRecipe(ToolType.bow, 1)
								.addCost(Resource.wood, 5)
								.addCost(Resource.stone, 5)
								.addCost(Resource.string, 2));
				...
				anvilRecipes.add(
						new FurnitureRecipe(IronLantern.class)
								.addCost(Resource.ironIngot, 8)
								.addCost(Resource.slime, 5)
								.addCost(Resource.glass, 4));
				anvilRecipes.add(
						new FurnitureRecipe(GoldLantern.class)
								.addCost(Resource.goldIngot, 10)
								.addCost(Resource.slime, 5)
								.addCost(Resource.glass, 4));
				anvilRecipes.add(
						new ToolRecipe(ToolType.sword, 2)
				...
				anvilRecipes.add(
						new ToolRecipe(ToolType.claymore, 2)
								.addCostTool(ToolType.sword, 2, 1)
								.addCost(Resource.shard, 15));
				anvilRecipes.add(
						new ToolRecipe(ToolType.axe, 2)
								.addCost(Resource.wood, 5)
								.addCost(Resource.ironIngot, 5));
				...
				anvilRecipes.add(
						new ToolRecipe(ToolType.claymore, 3)
								.addCostTool(ToolType.sword, 3, 1)
								.addCost(Resource.shard, 15));
				anvilRecipes.add(
						new ToolRecipe(ToolType.axe, 3)
								.addCost(Resource.wood, 5)
				...
				anvilRecipes.add(
						new ToolRecipe(ToolType.claymore, 4)
								.addCostTool(ToolType.sword, 4, 1)
								.addCost(Resource.shard, 15));
				anvilRecipes.add(
				...
				furnaceRecipes.add(
						new ResourceRecipe(Resource.ironIngot)
								.addCost(Resource.ironOre, 4)
								.addCost(Resource.coal, 1));
				furnaceRecipes.add(
						new ResourceRecipe(Resource.goldIngot)
								.addCost(Resource.goldOre, 4)
								.addCost(Resource.coal, 1));
				furnaceRecipes.add(
				...
				ovenRecipes.add(
						new ResourceRecipe(Resource.steak)
								...
								.addCost(Resource.coal, 1));
				ovenRecipes.add(
						new ResourceRecipe(Resource.cookedfish)
								.addCost(Resource.rawfish, 1)); //.addCost(Resource.coal, 1));

				ovenRecipes.add(new ResourceRecipe(Resource.bread).addCost(Resource.wheat, 4));

				enchantRecipes.add(
						new ResourceRecipe(Resource.goldapple)
								.addCost(Resource.apple, 1)
								.addCost(Resource.goldIngot, 10));
				enchantRecipes.add(
						new ResourceRecipe(Resource.grassseeds)
								.addCost(Resource.seeds, 1)
								.addCost(Resource.flower, 2));
			}
		} catch (Exception e) {
