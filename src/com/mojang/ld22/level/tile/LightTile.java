...
public class LightTile extends Tile {
	...
	public LightTile(int id, Tile onType, int tile) {
		...
		if (tile == 4){ connectsToSand = true; connectsToWater = true; }
		if (tile == 5) connectsToGrass = false;
		if (tile == 6) connectsToGrass = true;
		if (tile == 7);
		if (tile == 17){ connectsToSand = true;connectsToWater = true;connectsToLava= true;}
	...
	public void tick(Level level, int xt, int yt) {
		...
		if (level.getTile(xt - 1, yt - 1) != Tile.torchsand){
		if (level.getTile(xt + 1, yt - 1) != Tile.torchsand){
		if (level.getTile(xt, yt + 1) != Tile.torchdirt){
		if (level.getTile(xt, yt - 1) != Tile.torchdirt){
		if (level.getTile(xt + 1, yt) != Tile.torchdirt){
		if (level.getTile(xt - 1, yt) != Tile.torchdirt){	
		if (level.getTile(xt, yt + 2) != Tile.torchdirt){
		if (level.getTile(xt, yt - 2) != Tile.torchdirt){
		if (level.getTile(xt + 2, yt) != Tile.torchdirt){	
		if (level.getTile(xt - 2, yt) != Tile.torchdirt){
		if (level.getTile(xt + 1, yt + 1) != Tile.torchdirt){
		if (level.getTile(xt - 1, yt + 1) != Tile.torchdirt){
		if (level.getTile(xt - 1, yt - 1) != Tile.torchdirt){
		if (level.getTile(xt + 1, yt - 1) != Tile.torchdirt){
		if (level.getTile(xt, yt + 1) != Tile.torchplank){
		if (level.getTile(xt, yt - 1) != Tile.torchplank){
		if (level.getTile(xt + 1, yt) != Tile.torchplank){
		if (level.getTile(xt - 1, yt) != Tile.torchplank){	
		if (level.getTile(xt, yt + 2) != Tile.torchplank){
		if (level.getTile(xt, yt - 2) != Tile.torchplank){
		if (level.getTile(xt + 2, yt) != Tile.torchplank){	
		if (level.getTile(xt - 2, yt) != Tile.torchplank){
		if (level.getTile(xt + 1, yt + 1) != Tile.torchplank){
		if (level.getTile(xt - 1, yt + 1) != Tile.torchplank){
		if (level.getTile(xt - 1, yt - 1) != Tile.torchplank){
		if (level.getTile(xt + 1, yt - 1) != Tile.torchplank){
		if (level.getTile(xt, yt + 1) != Tile.torchsbrick){
		if (level.getTile(xt, yt - 1) != Tile.torchsbrick){
		if (level.getTile(xt + 1, yt) != Tile.torchsbrick){
		if (level.getTile(xt - 1, yt) != Tile.torchsbrick){	
		if (level.getTile(xt, yt + 2) != Tile.torchsbrick){
		if (level.getTile(xt, yt - 2) != Tile.torchsbrick){
		if (level.getTile(xt + 2, yt) != Tile.torchsbrick){	
		if (level.getTile(xt - 2, yt) != Tile.torchsbrick){
		if (level.getTile(xt + 1, yt + 1) != Tile.torchsbrick){
		if (level.getTile(xt - 1, yt + 1) != Tile.torchsbrick){
		if (level.getTile(xt - 1, yt - 1) != Tile.torchsbrick){
		if (level.getTile(xt + 1, yt - 1) != Tile.torchsbrick){
		if (level.getTile(xt, yt + 1) != Tile.torchlo){
		if (level.getTile(xt, yt - 1) != Tile.torchlo){
		if (level.getTile(xt + 1, yt) != Tile.torchlo){
		if (level.getTile(xt - 1, yt) != Tile.torchlo){	
		if (level.getTile(xt, yt + 2) != Tile.torchlo){
		if (level.getTile(xt, yt - 2) != Tile.torchlo){
		if (level.getTile(xt + 2, yt) != Tile.torchlo){	
		if (level.getTile(xt - 2, yt) != Tile.torchlo){
		if (level.getTile(xt + 1, yt + 1) != Tile.torchlo){
		if (level.getTile(xt - 1, yt + 1) != Tile.torchlo){
		if (level.getTile(xt - 1, yt - 1) != Tile.torchlo){
		if (level.getTile(xt + 1, yt - 1) != Tile.torchlo){
		if (level.getTile(xt, yt + 1) != Tile.torchwool){
		if (level.getTile(xt, yt - 1) != Tile.torchwool){
		if (level.getTile(xt + 1, yt) != Tile.torchwool){
		if (level.getTile(xt - 1, yt) != Tile.torchwool){	
		if (level.getTile(xt, yt + 2) != Tile.torchwool){
		if (level.getTile(xt, yt - 2) != Tile.torchwool){
		if (level.getTile(xt + 2, yt) != Tile.torchwool){	
		if (level.getTile(xt - 2, yt) != Tile.torchwool){
		if (level.getTile(xt + 1, yt + 1) != Tile.torchwool){
		if (level.getTile(xt - 1, yt + 1) != Tile.torchwool){
		if (level.getTile(xt - 1, yt - 1) != Tile.torchwool){
		if (level.getTile(xt + 1, yt - 1) != Tile.torchwool){
		if (level.getTile(xt, yt + 1) != Tile.torchwoolred){
		if (level.getTile(xt, yt - 1) != Tile.torchwoolred){
		if (level.getTile(xt + 1, yt) != Tile.torchwoolred){
		if (level.getTile(xt - 1, yt) != Tile.torchwoolred){	
		if (level.getTile(xt, yt + 2) != Tile.torchwoolred){
		if (level.getTile(xt, yt - 2) != Tile.torchwoolred){
		if (level.getTile(xt + 2, yt) != Tile.torchwoolred){	
		if (level.getTile(xt - 2, yt) != Tile.torchwoolred){
		if (level.getTile(xt + 1, yt + 1) != Tile.torchwoolred){
		if (level.getTile(xt - 1, yt + 1) != Tile.torchwoolred){
		if (level.getTile(xt - 1, yt - 1) != Tile.torchwoolred){
		if (level.getTile(xt + 1, yt - 1) != Tile.torchwoolred){
		if (level.getTile(xt, yt + 1) != Tile.torchwoolblue){
		if (level.getTile(xt, yt - 1) != Tile.torchwoolblue){
		if (level.getTile(xt + 1, yt) != Tile.torchwoolblue){
		if (level.getTile(xt - 1, yt) != Tile.torchwoolblue){	
		if (level.getTile(xt, yt + 2) != Tile.torchwoolblue){
		if (level.getTile(xt, yt - 2) != Tile.torchwoolblue){
		if (level.getTile(xt + 2, yt) != Tile.torchwoolblue){	
		if (level.getTile(xt - 2, yt) != Tile.torchwoolblue){
		if (level.getTile(xt + 1, yt + 1) != Tile.torchwoolblue){
		if (level.getTile(xt - 1, yt + 1) != Tile.torchwoolblue){
		if (level.getTile(xt - 1, yt - 1) != Tile.torchwoolblue){
		if (level.getTile(xt + 1, yt - 1) != Tile.torchwoolblue){
		if (level.getTile(xt, yt + 1) != Tile.torchwoolgreen){
		if (level.getTile(xt, yt - 1) != Tile.torchwoolgreen){
		if (level.getTile(xt + 1, yt) != Tile.torchwoolgreen){
		if (level.getTile(xt - 1, yt) != Tile.torchwoolgreen){	
		if (level.getTile(xt, yt + 2) != Tile.torchwoolgreen){
		if (level.getTile(xt, yt - 2) != Tile.torchwoolgreen){
		if (level.getTile(xt + 2, yt) != Tile.torchwoolgreen){	
		if (level.getTile(xt - 2, yt) != Tile.torchwoolgreen){
		if (level.getTile(xt + 1, yt + 1) != Tile.torchwoolgreen){
		if (level.getTile(xt - 1, yt + 1) != Tile.torchwoolgreen){
		if (level.getTile(xt - 1, yt - 1) != Tile.torchwoolgreen){
		if (level.getTile(xt + 1, yt - 1) != Tile.torchwoolgreen){	
		if (level.getTile(xt, yt + 1) != Tile.torchwoolyellow){
		if (level.getTile(xt, yt - 1) != Tile.torchwoolyellow){
		if (level.getTile(xt + 1, yt) != Tile.torchwoolyellow){
		if (level.getTile(xt - 1, yt) != Tile.torchwoolyellow){	
		if (level.getTile(xt, yt + 2) != Tile.torchwoolyellow){
		if (level.getTile(xt, yt - 2) != Tile.torchwoolyellow){
		if (level.getTile(xt + 2, yt) != Tile.torchwoolyellow){	
		if (level.getTile(xt - 2, yt) != Tile.torchwoolyellow){
		if (level.getTile(xt + 1, yt + 1) != Tile.torchwoolyellow){
		if (level.getTile(xt - 1, yt + 1) != Tile.torchwoolyellow){
		if (level.getTile(xt - 1, yt - 1) != Tile.torchwoolyellow){
		if (level.getTile(xt + 1, yt - 1) != Tile.torchwoolyellow){
		if (level.getTile(xt, yt + 1) != Tile.torchwoolblack){
		if (level.getTile(xt, yt - 1) != Tile.torchwoolblack){
		if (level.getTile(xt + 1, yt) != Tile.torchwoolblack){
		if (level.getTile(xt - 1, yt) != Tile.torchwoolblack){	
		if (level.getTile(xt, yt + 2) != Tile.torchwoolblack){
		if (level.getTile(xt, yt - 2) != Tile.torchwoolblack){
		if (level.getTile(xt + 2, yt) != Tile.torchwoolblack){	
		if (level.getTile(xt - 2, yt) != Tile.torchwoolblack){
		if (level.getTile(xt + 1, yt + 1) != Tile.torchwoolblack){
		if (level.getTile(xt - 1, yt + 1) != Tile.torchwoolblack){
		if (level.getTile(xt - 1, yt - 1) != Tile.torchwoolblack){
		if (level.getTile(xt + 1, yt - 1) != Tile.torchwoolblack){
		if (til == 0){
			...
			if (item instanceof ToolItem) {
				...
				if (tool.type == ToolType.shovel) {
					if (player.payStamina(2 - tool.level)) {
						level.add(new ItemEntity(new ResourceItem(Resource.flower), xt * 16 + random.nextInt(10) + 3, yt * 16 + random.nextInt(10) + 3));
						level.add(new ItemEntity(new ResourceItem(Resource.rose), xt * 16 + random.nextInt(10) + 3, yt * 16 + random.nextInt(10) + 3));
						level.setTile(xt, yt, Tile.grass, 0);
						return true;
					}
				}
		...
		if (til == 9){
			if (item instanceof ToolItem) {
				...
				if (tool.type == ToolType.axe) {
					if (player.payStamina(4 - tool.level)) {
						level.setTile(xt, yt, Tile.hole, 0);
						level.add(new ItemEntity(new ResourceItem(Resource.plank), xt * 16 + random.nextInt(10) + 3, yt * 16 + random.nextInt(10) + 3));
						Sound.monsterHurt.play();
						return true;
					}
				}
		...
		if (til == 18){
			if (item instanceof ToolItem) {
				...
				if (tool.type == ToolType.shovel) {
					if (player.payStamina(3 - tool.level)) {
						level.setTile(xt, yt, Tile.hole, 0);
						level.add(new ItemEntity(new ResourceItem(Resource.wool), xt * 16 + random.nextInt(10) + 3, yt * 16 + random.nextInt(10) + 3));
						Sound.monsterHurt.play();
						return true;
					}
				}
		...
		if (til == 19){
			if (item instanceof ToolItem) {
				...
				if (tool.type == ToolType.shovel) {
					if (player.payStamina(3 - tool.level)) {
						level.setTile(xt, yt, Tile.hole, 0);
						level.add(new ItemEntity(new ResourceItem(Resource.redwool), xt * 16 + random.nextInt(10) + 3, yt * 16 + random.nextInt(10) + 3));
						Sound.monsterHurt.play();
						return true;
					}
				}
		...
		if (til == 20){
			if (item instanceof ToolItem) {
				...
				if (tool.type == ToolType.shovel) {
					if (player.payStamina(3 - tool.level)) {
						level.setTile(xt, yt, Tile.hole, 0);
						level.add(new ItemEntity(new ResourceItem(Resource.bluewool), xt * 16 + random.nextInt(10) + 3, yt * 16 + random.nextInt(10) + 3));
						Sound.monsterHurt.play();
						return true;
					}
				}
		...
		if (til == 21){
			if (item instanceof ToolItem) {
				...
				if (tool.type == ToolType.shovel) {
					if (player.payStamina(3 - tool.level)) {
						level.setTile(xt, yt, Tile.hole, 0);
						level.add(new ItemEntity(new ResourceItem(Resource.greenwool), xt * 16 + random.nextInt(10) + 3, yt * 16 + random.nextInt(10) + 3));
						Sound.monsterHurt.play();
						return true;
					}
				}
		...
		if (til == 22){
			if (item instanceof ToolItem) {
				...
				if (tool.type == ToolType.shovel) {
					if (player.payStamina(3 - tool.level)) {
						level.setTile(xt, yt, Tile.hole, 0);
						level.add(new ItemEntity(new ResourceItem(Resource.yellowwool), xt * 16 + random.nextInt(10) + 3, yt * 16 + random.nextInt(10) + 3));
						Sound.monsterHurt.play();
						return true;
					}
				}
