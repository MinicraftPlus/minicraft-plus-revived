...
public class ClothingItem extends StackableItem {
	...
	protected static ArrayList<Item> getAllInstances() {
		...
		items.add(new ClothingItem("Reg Clothes",  new SpriteLink.SpriteLinkBuilder(SpriteType.Item, "reg_clothes").createSpriteLink(), Color.get(1, 51, 51, 0)));
	...
	private ClothingItem(String name, SpriteLink sprite, int pcol) { this(name, 1, sprite, pcol); }
