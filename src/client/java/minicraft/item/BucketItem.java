	...
	public boolean interactOn(Tile tile, Level level, int xt, int yt, Player player, Direction attackDir) {
		...
		if (filling != Fill.Empty) {
			if (fill == Fill.Empty) {
				...
				if (!Game.isMode("minicraft.displays.world_gen.options.game_mode.creative")) player.activeItem = editBucket(player, Fill.Empty);
				return true;
			...
			if (!Game.isMode("minicraft.displays.world_gen.options.game_mode.creative")) player.activeItem = editBucket(player, fill);
			return true;
		}
