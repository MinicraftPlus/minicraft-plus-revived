...
public class Zombie extends EnemyMob {
	...
	public void die() {
		if (Settings.get("diff").equals("minicraft.displays.world_gen.options.difficulty.easy")) dropItem(2, 4, Items.get("cloth"));
		if (Settings.get("diff").equals("minicraft.displays.world_gen.options.difficulty.normal")) dropItem(1, 3, Items.get("cloth"));
		if (Settings.get("diff").equals("minicraft.displays.world_gen.options.difficulty.hard")) dropItem(1, 2, Items.get("cloth"));
